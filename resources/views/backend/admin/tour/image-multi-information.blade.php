    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-body">
              <div class="col-md-12">
                <form action="{{url('/admin/upload-tour-image-multi')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="row">
                        <div class="col-lg-12">
...
<div class="row mt-3">
    ...
    <div class="col-md-3">
        <div class="card">
            <img src="{{url('/image_upload/image_tour_multi')}}/{{$value->image_multi}}" class="img-responsive" width="100%;"><br>
            <div class="row">
                ...
                <div class="col-md-4 col-4">
                    <a href="{{url('/admin/tour-image-multi-delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')" style="color: red;">
                        ลบรูปภาพ
                    </a>
                </div>
            </div>
    ...
    <div class="modal fade" id="modal-tour-edit{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('/admin/update-tour-image-multi')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="row">
                            <div class="col-lg-12">
                                @if ($errors->has('image_multi'))
                                    <span class="text-danger" style="font-size: 17px;">({{ $errors->first('image_multi') }})</span>
