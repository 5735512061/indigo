  ...
  <div class="col-xl-12">
    ...
    <div class="card">
      <div class="card-header border-0"  style="padding-left: 0;">
          <a href="{{url('/admin/create-article')}}" class="btn btn-primary">เพิ่มข้อมูลบทความ</a>
      </div>
        ...
        <table class="table align-items-center table-flush">
          <thead class="thead-light">
            <tr>
              ...
              <th scope="col">บทความ (ภาษาอังกฤษ)</th>
          ...
          <tbody>
            @foreach ($articles as $article => $value)
              <tr>
                ...
                <td>
                  <a href="" type="button" data-toggle="modal" data-target="#modal-article-eng{{$value->id}}" data-id="{{$value->id}}">
                    ดูเพิ่มเติม
                  </a>
                  <a href="{{url('/admin/edit-article')}}/{{$value->id}}">
                    <i class="fa fa-pencil-square" style="color:blue; font-size:18px;"></i>
                ...
                <td>
                  <a href="{{url('/admin/article-image-multi-information/')}}/{{$value->id}}">
                    <i class="fa fa-folder" style="color:blue; font-size:18px;"></i>
                  </a>
                </td>
                <td>{{$value->status}}</td>
                <td>
                  <a href="" type="button" data-toggle="modal" data-target="#modal-article-edit{{$value->id}}" data-id="{{$value->id}}">
                    <i class="fa fa-pencil-square" style="color:blue; font-size:18px;"></i>
                  </a>
                  <a href="{{url('/admin/article-delete/')}}/{{$value->id}}" onclick="return confirm('Are you sure to delete ?')">
              ...
              <!-- Modal -->
              <div class="modal fade" id="modal-article-eng{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-body">
                          <div class="col-md-12">
              ...
              <!-- Modal -->
              <div class="modal fade" id="modal-article-edit{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-body">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLongTitle">แก้ไขข้อมูลบทความ</h5>
                        </div>
                        <form action="{{url('/admin/update-article')}}" enctype="multipart/form-data" method="post">@csrf
                          <div class="pl-lg-4">
                            <div class="row">
                              <div class="col-lg-12">
                                  @if ($errors->has('title'))
